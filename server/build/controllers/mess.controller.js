...
var messController = {
    getMess: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var id, message;
    ...
    postSendMessages: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var room_id, user_id, room, text, newMess, updatedRoom;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    room_id = req.signedCookies.room_id;
                    user_id = req.signedCookies.cookie_id;
                    return [4 /*yield*/, room_model_1["default"].findOne({ id: room_id })];
                case 1:
                    room = _a.sent();
                    text = req.body.text;
                ...
                case 3:
                    updatedRoom = _a.sent();
                    console.log("updatedRoom: ".concat(updatedRoom));
                    return [2 /*return*/];
            }
        });
    }); }
